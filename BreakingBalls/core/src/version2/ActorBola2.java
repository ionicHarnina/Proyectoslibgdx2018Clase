...
public class ActorBola2 extends Actor implements Disposable {
	...
	public ActorBola2(int posX, int posY, String texture) {
		super();
	...
	private void fixCollision(ActorBola2 bola2) {
		this.velocidad.x *= -1;
		bola2.velocidad.x *= -1;
		this.velocidad.y *= -1;
		bola2.velocidad.y *= -1;
	...
	private boolean testingCollision(ActorBola2 bola2) {
